                                ...
                                <div className="col-md-2">
                                    <Link href="https://www.facebook.com/RetterLaw/" legacyBehavior>
                                        <a target="_blank" className={`${styles.footerSocialMedia}`}>
                                            <i className={`${styles.footerSocialIcon} bi bi-facebook `}/>
                                        </a>
                                    </Link>
                                </div>
                                <div className="col-md-2">
                                    <Link href="/" legacyBehavior>
                                        <a target="_blank" className={`${styles.footerSocialMedia}`}>
                                            <i className={`${styles.footerSocialIcon} bi bi-instagram `}/>
                                        </a>
                                    </Link>
                                </div>
                                <div className="col-md-2">
                                    <Link href="/" legacyBehavior>
                                        <a target="_blank" className={`${styles.footerSocialMedia}`}>
                                            <i className={`${styles.footerSocialIcon} bi bi-linkedin `}/>
                                        </a>
                                    </Link>
                                </div>
                            </div>
                    ...
                    <div className="col">
                        ...
                        <div>
                            <a href="#" className={`${styles.footerSocialMedia}`}>
                                <i className={`${styles.footerSocialIcon} bi bi-geo-alt-fill`}/>
                            </a>
                            <span className="m-3">טקסט לורם איפסום בעברית לטובת</span>
                        </div>
                        <div>
                            <a href="#" className={`${styles.footerSocialMedia}`}>
                                <i className={`${styles.footerSocialIcon} bi bi-telephone-fill`}/>
                            </a>
                            <span className="m-3">טקסט לורם איפסום בעברית לטובת</span>
                        </div>
                        ...
                        <div>
                            <a href="#" target="_blank" className={`${styles.footerSocialMedia}`}>
                                <i className={`${styles.footerSocialIcon} bi bi-envelope-fill`}/>
                            </a>
                            <span className="m-3">טקסט לורם איפסום בעברית לטובת</span>
                        </div>
                    </div>
